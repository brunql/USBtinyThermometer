...
int usbOpenDevice(usb_dev_handle **device, int vendorID, char *vendorNamePattern, int productID, char *productNamePattern)
{
struct usb_bus      *bus;
...
char *serialNamePattern = NULL;
FILE *printMatchingDevicesFp = NULL;
FILE *warningsFp = NULL;
